...
title('kmeans')
[~,y_predicted_rnd]=EM(x_data,3,'random',500,10^-5,'MAP');
[~,y_predicted_rnd_data]=EM(x_data,3,'data_random',500,10^-5,'MAP');
[~,y_predicted_k_means]=EM(x_data,3,'k_means',500,10^-5,'MAP');
...
ccr_y_k_means=label_clustring_ccr(y_k_means,3,y_data);
